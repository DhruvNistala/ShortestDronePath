...
public class DijkstraSP {
    ...
    //computes shortest-paths tree from source to every other vertex
    ...
    //relax edge e, update pq if needed
    ...
    //returns shortest path from source to destination vertex
    public double distTo(int v) {
        validateVertex(v);
        return distTo[v];
    }
    
    //returns whether there is path from source to v
